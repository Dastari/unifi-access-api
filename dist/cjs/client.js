...
exports.UnifiAccessApiError = UnifiAccessApiError;
class UnifiAccessHttpError extends Error {
...
exports.UnifiAccessHttpError = UnifiAccessHttpError;
...
class UnifiAccessApi {
    ...
    attachEndpoints() {
        for (const key of Object.keys(index_js_1.endpointDefinitions)) {
            const definition = index_js_1.endpointDefinitions[key];
    ...
    prepareBody(definition, options, headers) {
        ...
        if (typeof body === 'object') {
            if (!headers['Content-Type']) {
                headers['Content-Type'] = endpoint_js_1.JSON_CONTENT_TYPE;
            }
