...
exports.createNotificationClientFromApiOptions = exports.UnifiAccessNotificationClient = void 0;
 ...
 */
class UnifiAccessNotificationClient extends events_1.EventEmitter {
    constructor(options) {
        super();
        ...
        this.WebSocketImpl = options.WebSocketImpl ?? ws_1.default;
...
exports.UnifiAccessNotificationClient = UnifiAccessNotificationClient;
/**
 ...
 */
const createNotificationClientFromApiOptions = (options, overrides = {}) => {
...
exports.createNotificationClientFromApiOptions = createNotificationClientFromApiOptions;
