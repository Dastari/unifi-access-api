...
export type EndpointPathParams<Def extends EndpointDefinition<any, any, any, any, any>> =
  Def extends EndpointDefinition<infer P, any, any, any, any> ? P : never;

export type EndpointQueryParams<Def extends EndpointDefinition<any, any, any, any, any>> =
  Def extends EndpointDefinition<any, infer Q, any, any, any> ? Q : never;

export type EndpointRequestBody<Def extends EndpointDefinition<any, any, any, any, any>> =
  Def extends EndpointDefinition<any, any, infer B, any, any> ? B : never;

export type EndpointInvoker<Def extends EndpointDefinition<any, any, any, any, any>> =
  RequiredKeys<EndpointCallOptions<Def>> extends never
    ? (options?: EndpointCallOptions<Def>) => Promise<InferResponse<Def>>
    : (options: EndpointCallOptions<Def>) => Promise<InferResponse<Def>>;
