...
export interface SystemLogsResponse extends ApiResponse<{ hits: SystemLogRecord[] }> {
  page?: number;
  total?: number;
}

export type ExportSystemLogsResponse = FileResponse;
export interface StaticResourceResponse extends FileResponse {}
